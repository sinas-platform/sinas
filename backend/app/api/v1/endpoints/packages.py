...
async def install_package(
    ...
    result = await db.execute(
        select(InstalledPackage).where(InstalledPackage.package_name == package_data.package_name)
    )
...
async def remove_package(
    ...
    """
    result = await db.execute(select(InstalledPackage).where(InstalledPackage.id == package_id))
