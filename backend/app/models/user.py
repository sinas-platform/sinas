...
class PasswordResetToken(Base):
    """
    One-time password reset tokens. Generated by an admin via the user
    management endpoint and delivered out-of-band to the user. Token is
    hashed at rest; plaintext is returned to the admin only once.
    """
