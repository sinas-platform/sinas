...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_groups_external_group_id"), "groups", ["external_group_id"], unique=True
    )
    ...
    op.create_index(
        "ix_group_permission_unique",
        "group_permissions",
        ["group_id", "permission_key"],
        unique=True,
    )
    op.create_index(
        op.f("ix_group_permissions_group_id"), "group_permissions", ["group_id"], unique=False
    )
    op.create_index(
        op.f("ix_group_permissions_permission_key"),
        "group_permissions",
        ["permission_key"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_installed_packages_user_id"), "installed_packages", ["user_id"], unique=False
    )
    op.create_table(
        "mcp_servers",
        sa.Column("id", GUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_refresh_tokens_token_prefix"), "refresh_tokens", ["token_prefix"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_scheduled_jobs_group_id"), "scheduled_jobs", ["group_id"], unique=False
    )
    ...
    op.create_index(
        "ix_states_namespace_visibility", "states", ["namespace", "visibility"], unique=False
    )
    ...
    op.create_index(
        "uq_state_user_namespace_key", "states", ["user_id", "namespace", "key"], unique=True
    )
    op.create_table(
        "webhooks",
        sa.Column("id", GUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_function_versions_function_id"), "function_versions", ["function_id"], unique=False
    )
    op.create_table(
        "executions",
        sa.Column("id", GUID(), nullable=False),
        ...
        sa.Column("function_name", sa.String(length=255), nullable=False),
        sa.Column(
            "trigger_type", sa.Enum("WEBHOOK", "SCHEDULE", name="triggertype"), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_executions_function_name"), "executions", ["function_name"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_step_executions_execution_id"), "step_executions", ["execution_id"], unique=False
    )
